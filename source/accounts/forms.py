...
class DocumentFormStegno(forms.ModelForm):
    class Meta:
        model = UploadedDocumentsStegno
        fields = ('name', 'documents', )


from .models import ShareFile,ShareFileStegnoModel
class ShareFileCryptoForm(forms.ModelForm):
    class Meta:
        model = ShareFile
        fields = ('file_id',)

class ShareFileStegnoForm(forms.ModelForm):
    class Meta:
